...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'フリーランス新法・下請法の違反条項をAIが30秒で発見。条文番号付きで指摘。300円〜・月980円で使い放題、登録不要で1回無料お試し。',
  ...
  offers: [
    {
      ...
      price: '0',
      priceCurrency: 'JPY',
      description: '登録不要で1回無料お試し診断。クレジットカード不要。',
    },
    {
      '@type': 'Offer',
      name: '単発診断プラン',
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '契約書チェッカー（ワークシールド）は、フリーランスや業務委託の契約書をAIが自動診断するWebサービスです。フリーランス新法（2024年11月施行）と下請法の全条項に照らして契約書を分析し、違反箇所を条文番号付きで指摘・修正案を提示します。1回300円、月980円で使い放題。登録不要で1回無料お試し可能です。',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '契約書チェッカーは1回300円から利用できます。毎月何度も使う場合は月980円の定額使い放題プランがあり、これはChatGPTなど汎用AIツール（月約3,000円）の約1/3の価格です。30秒で診断結果が得られ、登録不要で1回無料お試し診断も可能です（クレジットカード不要）。',
      },
    },
    {
      '@type': 'Question',
...
const howToSchema = {
  ...
  step: [
    ...
    },
    {
      ...
      position: 2,
      name: 'サービスに貼り付ける',
      text: '契約書の内容をアップロードまたはテキスト貼り付けします。初回は登録不要で1回無料で診断できます。',
    },
    {
      '@type': 'HowToStep',
      position: 3,
