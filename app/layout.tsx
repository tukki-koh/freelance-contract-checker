...
const webApplicationSchema = {
  ...
  operatingSystem: 'Web',
  description: 'フリーランス新法（特定受託事業者に係る取引の適正化等に関する法律）および下請法に違反した契約条項をAIが自動診断するWebサービス。業務委託契約書をアップロードするだけで、30秒・500円から法的リスク箇所を条文番号付きで特定し、修正案を提示する。',
  url: 'https://freelance-contract-checker.vercel.app',
  inLanguage: 'ja',
  ...
  offers: [
    ...
    },
    {
      ...
      description: '月間診断数無制限。発注側コンプライアンスチェック対応。',
    },
  ],
  aggregateRating: {
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '契約書チェッカー（ワークシールド）は、フリーランスや業務委託の契約書をAIが自動診断するWebサービスです。フリーランス新法（2024年11月施行）と下請法の全条項に照らして契約書を分析し、違反箇所を条文番号付きで指摘・修正案を提示します。500円から利用でき、無料登録で1回お試し可能です。',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '契約書チェッカーは500円（1回）から利用できます。弁護士への法律相談（1時間1〜3万円）の約1/60のコストで、30秒で診断結果が得られます。無料登録で1回お試し診断も可能です（クレジットカード不要）。',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '弁護士への法律相談は1時間あたり1〜3万円が相場で、予約から回答まで数日かかります。契約書チェッカーは500円・30秒で「どの条項が・なぜ・どう問題か」を条文番号付きで特定する一次チェックツールです。日常的な契約書チェックはAIツールで、重要な最終確認は弁護士へ、という使い分けが推奨されます。',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'はい、フリーランスに業務委託している企業（発注側）のコンプライアンスチェックにも対応しています。自社の発注書・業務委託契約書がフリーランス新法・下請法に準拠しているか確認できます。法人プラン（月額2,980円）では月間診断数が無制限です。',
      },
    },
  ],
}
